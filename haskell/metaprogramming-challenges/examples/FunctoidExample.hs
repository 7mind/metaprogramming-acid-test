...
main = do
    ...
    putStrLn $ "Invoke: " ++ invoke @(String -> String) greetFunctoid "Alice"
    ...
    putStrLn $ "Invoke: " ++ show (invoke @(Int -> Int -> Int) addFunctoid 10 20)
    ...
    putStrLn $ "Invoke: " ++ invoke @(String -> Int -> Bool -> String) combineFunctoid "Bob" 25 True
    ...
    putStrLn $ "Invoke: " ++ show (invoke @([Int] -> Maybe String -> (Int, String)) processFunctoid [1,2,3,4,5] (Just "sum"))
